...
namespace NZTrails.API.Migrations
{
    ...
    [Migration("20220713185932_AddingUsersAndRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZTrails.API.Models.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NZTrails.API.Models.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZTrails.API.Models.Domain.User_Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZTrails.API.Models.Domain.User_Role", b =>
                {
                    b.HasOne("NZTrails.API.Models.Domain.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NZTrails.API.Models.Domain.User", "User")
                        .WithMany("UserRoles")
